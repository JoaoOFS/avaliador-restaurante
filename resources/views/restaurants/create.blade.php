...
<div class="min-h-screen py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-8">
            <h1 class="text-3xl font-bold text-light mb-2">Adicionar Novo Restaurante</h1>
            <p class="text-gray-400">Compartilhe sua experiência gastronômica com a comunidade</p>
        </div>

        <form action="{{ route('restaurants.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    <div class="flex-1 grid grid-cols-2 gap-2">
                                        <input type="time"
                                               ...
                                               value="{{ old("opening_hours.$day.open") }}"
                                        ...
                                        <input type="time"
                                               ...
                                               value="{{ old("opening_hours.$day.close") }}"
                                               class="px-4 py-2 rounded-lg bg-input-bg border border-card-border text-light focus:ring-2 focus:ring-primary focus:border-primary transition-all duration-200">
                                    </div>
                                </div>
                            @endforeach
                    ...
                    <div>
                        ...
                        <select name="price_range"
                                ...
                                required>
                            <option value="">Selecione uma opção</option>
                            <option value="1" {{ old('price_range') == '1' ? 'selected' : '' }}>$ - Econômico</option>
                            <option value="2" {{ old('price_range') == '2' ? 'selected' : '' }}>$$ - Moderado</option>
                            <option value="3" {{ old('price_range') == '3' ? 'selected' : '' }}>$$$ - Alto</option>
                            <option value="4" {{ old('price_range') == '4' ? 'selected' : '' }}>$$$$ - Luxuoso</option>
                        </select>
                        @error('price_range')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        @enderror
            ...
            <div class="card hover-3d animate-on-scroll">
                ...
                <div class="space-y-4">
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4" id="photo-preview">
                        <!-- Preview das fotos será inserido aqui -->
                    </div>
