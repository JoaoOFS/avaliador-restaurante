...
@section('title', 'Editar Cozinha')
@section('header', 'Editar Cozinha')
@section('subheader', $cuisine->name)

@section('content')
    <div class="max-w-3xl mx-auto">
        <form action="{{ route('cuisines.update', $cuisine) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')

            <div class="card">
                <div class="p-6">
                    <h3 class="text-lg font-semibold mb-4">Informações da Cozinha</h3>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="text" name="name" id="name" value="{{ old('name', $cuisine->name) }}" required
                                       class="w-full pl-10 @error('name') border-red-500 @enderror"
                                       placeholder="Ex: Cozinha Italiana">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <textarea name="description" id="description" rows="4" required
                                          ...
                                          placeholder="Descreva a cozinha...">{{ old('description', $cuisine->description) }}</textarea>
                        ...
                        <div>
                            ...
                            <div class="flex items-center space-x-4">
                                <div class="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center group-hover:bg-primary/20 transition-colors">
                                    <i class="{{ old('icon', $cuisine->icon) }} text-2xl text-primary" id="icon-preview"></i>
                                </div>
                                <div class="flex-1">
                                    <div class="relative">
                                        <input type="text" name="icon" id="icon" value="{{ old('icon', $cuisine->icon) }}" required
                        ...
                        <div>
                            ...
                            <div class="flex items-center">
                                <label class="relative inline-flex items-center cursor-pointer">
                                    ...
                                    <span class="ml-3 text-sm text-gray-400">Cozinha ativa</span>
                                </label>
                            </div>
                        </div>
                    </div>
            ...
            <div class="flex justify-end space-x-4">
                <a href="{{ route('cuisines.show', $cuisine) }}" class="btn btn-secondary">
